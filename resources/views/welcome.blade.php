...
@endif
    ...
    <div style="position: fixed; 
                ...
                width: 100%; 
                height: 100%; 
                background-image: url('{{ asset('favicon_io/background-mihu.jpeg') }}'); 
    ...
    <div style="position: relative; z-index: 1;">
        ...
        <div class="leading-tight">
            <span style="font-size:50px;color:#feff03;
