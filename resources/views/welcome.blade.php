    ...
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block" style="z-index: 9999;">
        ...
        @else
            <a href="{{ route('login') }}" 
               ...
               <!-- Icon SVG (bisa ganti dengan bi class jika ada bootstrap icons) -->
            ...
            <style>
                ...
                .login-btn-yellow:hover span:last-child {
                    transform: translateX(100%);
                }
                
                /* Pastikan tombol terlihat di atas background */
                .login-btn-yellow {
...
@endif
    ...
    <div style="position: fixed; 
                ...
                width: 100%; 
                height: 100%; 
                background-image: url('{{ asset('favicon_io/background-unsur.png') }}'); 
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <h1 class="flex items-center text-gray-900 dark:text-white">
                    <img src="{{asset('favicon_io/logo-pascasarjana-unsur-512x512.png')}}" 
                    class="mr-3"
                    height="100" width="100">

                <div class="leading-tight">
                <span style="font-size:80px;color:#feff03;text-shadow:-2px -2px 0 #000,2px -2px 0 #000,-2px 2px 0 #000,2px 2px 0 #000;">
                Pasca UNSUR
                </span>
                </div>
                </h1>
                    <span class="ml-4" style="font-size: 100px; color:#1a202c;"> </span>
                    <h1 class="flex items-center text-gray-900 dark:text-white">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm sm:text-center sm:ml-0" style="color: white;">
    Copyright@2025 MIHU. All Rights Reserved.
</div>
                </div>
            </div>
        </div>
