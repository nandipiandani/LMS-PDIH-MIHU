...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Buat Ujian</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Beranda</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Buat Ujian</li>
                        </ol>
                    </nav>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('exam.create')}}" method="POST">
                                    ...
                                    <div>
                                        <p>Pilih Semester:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <p>Nama Ujian<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                        <input type="text" class="form-control" name="exam_name" placeholder="Kuis, Tugas, Ujian Tengah Semester, Ujian Akhir Semester, ..." aria-label="Quiz, Assignment, Mid term, Final, ...">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputStarts" class="form-label">Mulai<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="datetime-local" class="form-control" id="inputStarts" name="start_date" placeholder="Mulai">
                                    </div>
                                    <div class="mt-2">
                                        <label for="inputEnds" class="form-label">Selesai<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                        <input type="datetime-local" class="form-control" id="inputEnds" name="end_date" placeholder="Selesai">
                                    </div>
